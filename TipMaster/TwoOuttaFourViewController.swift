//
//  TwoOuttaFourViewController.swift
//  TipMaster
//
...
class TwoOuttaFourViewController: UIViewController {
    ...
    @IBAction func choseOneFriendly(_ sender: Any) {
    ...
    @IBAction func choseTwoFriendly(_ sender: Any) {
        let defaults = UserDefaults.standard
        var updateOne = defaults.integer(forKey: "Score")
    ...
    @IBAction func choseFourFriendly(_ sender: Any) {
        let defaults = UserDefaults.standard
        var updateOne = defaults.integer(forKey: "Score")
        updateOne = updateOne + 4
        defaults.set(updateOne, forKey: "Score")
    }
    @IBAction func choseFiveFriendly(_ sender: Any) {
        let defaults = UserDefaults.standard
        var updateOne = defaults.integer(forKey: "Score")
